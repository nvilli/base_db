...
__C.GPUS = 1                      # Setting the number of GPU
__C.USE_SUMMARY = False             # To save log of tensorboard. If you need it,the flag should be set True.
__C.SUPER_LOADER = True         # TODO: If you have sufficient CPU and Memory, the flag is used to accelerate dataloader.
...
__C.PRETRAIN_TYPE = None # 'imagenet'     # backbone pretrain type ['imagenet','kinetics',None]
...
__C.SNAPSHOT_ROOT = "/data/guojie"        # To set root path which saves output of framework
...
#                   |-MetafileOrg/
__C.DATASET = edict()
__C.DATASET.ROOT_PATH = "/data/guojie" # The root path of Dataset
# __C.DATASET.NAME = "SomethingV2"     # The name of Dataset
__C.DATASET.NAME = "HMDB51"
# self_supervised learning class_num
__C.DATASET.CLASS_NUM = 24     # TODO: CLASS_NUM
...
__C.TRAIN = edict()
__C.TRAIN.EPOCHS = 300         # The number of Epoch
__C.TRAIN.BASE_BATCH_SIZE = 8    # TODO: BASE_BATCH_SIZE
...
__C.TRAIN.PRETRAIN_MODEL = None# __C.PRETRAIN_MODEL_DICT[__C.MODEL_NAME][__C.BACKBONE][__C.PRETRAIN_TYPE]# _C.PRETRAIN_MODEL_ZOO + C.TRAIN.PRETRAIN_MODEL
